	 ...
	 ?>
		<div class="right"><br>
			...
			<center>
				...
				<input type="text" name="maritalstatus" class="form" value="<?php echo $row['maritalstatus']; ?>" required="required"><br><br>
			...
			<?php 
			extract($_POST);
			if (isset($btn) && !empty($fname) && !empty($sname) && !empty($maritalstatus) && !empty($phone) && !empty($address) &&!empty($gender) && !empty($birthyear) && !empty($bloodgroup)) {
