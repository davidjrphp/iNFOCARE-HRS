	...
	<?php
	 ...
	 ?>
		<div class="right"><b><br>
		 <a href="medical.php" style="margin-left:10px;"><button class="btnlink">back</button></a><form action="searchdrug.php" method="get" style="float:right;margin-right:15px;"><input type="text" style="height:25px; width:180px;padding-left:15px;" name="s" placeholder="Search Drug By Name"></form><br>
			<center>
			<?php 
				...
				while ($row=mysqli_fetch_array($sql)) {
				 ...
				 ?><br><br>
				 <center><h3><b>Drug Details</b></h3></center><br><br>
				...
				<input type="reset" value="Clear" class="btnlink" name="btn">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" value="Finalize" class="btnlink" name="btn"><br><br>
			</form>
			<?php 
			extract($_POST);
