 ...
 <?php
    ...
    <div class="content-wrapper">
      <div class="container-fluid">
        	...
        	<li class="breadcrumb-item active">Asdmin Panel</li>
      	</ol>
    ...
    <button class="btn btn-outline-success" type="submit">Search</button>
        ...
        <div class="card-header">
            <i class="fa fa-table"></i> Service Queues &nbsp;&nbsp;<a href="addqueue.php" class="btn btn-primary  ">  <i class="fa fa-plus-circle fw-fa"></i>Add New</a>
		</div>
            <div class="card-body">
