	...
	<legend><h3>Patient's Information</h3></legend>
		...
		<div class="form-row">
			...
			<label for="Gender">Gender:</label>
				...
				<select class="form-control input-sm" name="sex" id="gender" value="<?php echo $row['sex']; ?>">
...
<fieldset>
	...
	<div class="form-group">
      ...
      <div class="col-md">
		...
		<button class="btn btn-primary btn-block" name="submit" type="submit" ><span class="glyphicon glyphicon-floppy-update"></span>Update</button>
	</form>
