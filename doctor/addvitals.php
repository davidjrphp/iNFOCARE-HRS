...
<br><br><br>
	...
	<?php
	 ...
	 ?>
		<div class="right"><br>
		<center>
				<form action="addvitals.php?id=<?php echo $id = $_GET['id']; ?>" method="POST">
			...
			<center>
				...
				<textarea required="required" name="comments" id="comments" class="form" style="height:100px; padding-left:20px;padding-top:20px;font-family:Arial;" placeholder="Please Enter Comments"></textarea><br><br>
